package otang.network.crash.activity;
...
import otang.network.crash.config.CrashConfig;

public final class CrashActivity {

	private final static String TAG = "CrashActivity";
	//Extras passed to the error activity
	private static final String EXTRA_CONFIG = "otang.network.EXTRA_CONFIG";
	private static final String EXTRA_STACK_TRACE = "otang.network.EXTRA_STACK_TRACE";
	private static final String EXTRA_ACTIVITY_LOG = "otang.network.EXTRA_ACTIVITY_LOG";
	//General constants
	private static final String INTENT_ACTION_ERROR_ACTIVITY = "otang.network.ERROR";
	private static final String INTENT_ACTION_RESTART_ACTIVITY = "otang.network.RESTART";
	private static final String CRASH_HANDLER_PACKAGE_NAME = "otang.network.";
	private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
	private static final int MAX_STACK_TRACE_SIZE = 131071; //128 KB - 1
	private static final int MAX_ACTIVITIES_IN_LOG = 50;
	//Shared preferences
	private static final String SHARED_PREFERENCES_FILE = "otang.network_preferences";
